...
# default = 0 = none
#
# ARDUINO : AVR = EEPROM HID SPI SoftwareSerial Wire 
# ARDUINO : common = Bridge Esplora Ethernet Firmata GSM 
#	LiquidCrystal RobotIRremote Robot_Control Robot_Motor SD Servo 
#	SpacebrewYun Stepper TFT Temboo WiFi 
#
APP_LIBS_LIST = SPI EEPROM

# List user's libraries here
# !!! Help: http://bit.ly/2AEscDx
# default = 0 = none
#
# USER = Adafruit-MAX31855 Adafruit-ST7735 
#	Adafruit_BLEFirmata Adafruit_BluefruitLE_nRF51 Adafruit_FontConvert 
#	Adafruit_GFX Adafruit_SSD1306 ArduinoMenu Assert4a AutoDriver Bridge 
#	Buttons ClickButton ClickEncoder EEPROMex EncButton Encoder 
#	ExponentialFilter FRAM_MB85RS_SPI FastLED Firmata LEDex MAX6675 MENWIZ 
#	Menu MenuLCD MenuPages PDQ_GFX_Libs PID_v1 ProcessingPlotter 
#	ResponsiveAnalogRead RotaryEncoderAcceleration StatusScreen StopWatch 
...
#
COMPILER_OPTIONS = -DNONeurs -DNODEBUG
...
PROJECT_NAME_AS_IDENTIFIER = HP_ReflowSoldering
...
# For building, kepp main and tasks unchanged, false or true
KEEP_MAIN = false
KEEP_TASKS = false
