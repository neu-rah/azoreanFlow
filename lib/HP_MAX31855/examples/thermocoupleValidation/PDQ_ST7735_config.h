...
// NOTE: Modification of the PDQ_ST7735 lib to implement the use of SPI.beginTransaction and SPI.endTransaction for maximum compatibility
// Only valide with ST7735_SAVE_SPCR=1
enum
{
...
#define ST7735_RST_PIN  8     // <= RESET pin
...
// other PDQ library options, and Transactional SPI
